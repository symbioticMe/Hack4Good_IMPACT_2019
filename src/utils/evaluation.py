...
def auc_plot(model, title, x_test, y_test, x_train=None, y_train=None, prefit=False):
    """
...
def wrongly_classified(model, x_test, y_test, x_train=None, y_train=None, prefit=True):
    """
